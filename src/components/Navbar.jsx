        ...
        <div className="container nav-inner" style={{ flexWrap: 'wrap', alignItems: 'center' }}>
          ...
          <div className="nav-cta" style={{ display: 'flex', gap: '12px', alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <Link to="/profile" className="btn secondary distressed" style={{ textDecoration: 'none', fontWeight: 600, fontSize: '1.1rem', display: 'flex', alignItems: 'center', gap: 6 }} title="User Profile / Login">
              ...
              <Link to="/orders" className="btn secondary distressed" style={{ textDecoration: 'none', fontWeight: 600, fontSize: '1.1rem', display: 'flex', alignItems: 'center', gap: 6 }} title="View Orders">
                {/* Orders icon */}
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="4" width="18" height="16" rx="2"/><path d="M3 8h18"/><path d="M7 12h2v2H7z"/><path d="M11 12h2v2h-2z"/><path d="M15 12h2v2h-2z"/></svg>
